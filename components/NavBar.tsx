...
function NavBar() {
  ...
  return (
    <div className=" sticky top-0 z-10 py-2 px-10 flex gap-2 items-center justify-between bg-white max-sm:px-2">
      <Link href="/">
      ...
      <div className=" flex gap-3 border border-grey-2 px-3 py-2 items-center rounded-lg">
        ...
        <button disabled={query === ""}onClick={()=>router.push(`/search/${query}`)}>
          <Search className=" cursor-pointer h-4 w04 hover:text-red-1" />
        </button>
      </div>
